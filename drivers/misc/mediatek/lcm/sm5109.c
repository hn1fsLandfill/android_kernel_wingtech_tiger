...
/*static struct pinctrl_state *_lcm_gpio_enp_mode;
 ...
 static struct i2c_client *_lcm_i2c_client2;
 ...
 {
	 int ret = 0;
	 struct i2c_client *client = _lcm_i2c_client2;
	 char write_data[2] = { 0 };
 
	 if (client == NULL) {
		 pr_debug("ERROR!! _lcm_i2c_client2 is null\n");
		 return 0;
	 }
