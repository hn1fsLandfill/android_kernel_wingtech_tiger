...
#define AF_DRVNAME "DELTA_HI5021Q_GT9778AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long DELTA_HI5021Q_GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DELTA_HI5021Q_GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
     int Ret = 0;
...
int DELTA_HI5021Q_GT9778AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
             int *pAF_Opened)
{
...
int DELTA_HI5021Q_GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DELTA_HI5021Q_GT9778AF_GetFileName(unsigned char *pFileName)
{
