...
#include "n26_hi5021q_rear_delta_mipiraw_Sensor.h"

#define PFX "delta_hi5021q_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
     .sensor_id = N26_HI5021Q_REAR_DELTA_SENSOR_ID,
...
#if 1 ///otp code
static struct stCAM_CAL_DATAINFO_STRUCT n26_hi5021q_rear_delta_eeprom_data ={
     .sensorID= N26_HI5021Q_REAR_DELTA_SENSOR_ID,
     .deviceID = 0x01,
     .dataLength = 0x2149,
     .sensorVendorid = 0x1D000101,
     .vendorByte = {1,2,3,4},
     .dataBuffer = NULL,
};

static struct stCAM_CAL_CHECKSUM_STRUCT n26_hi5021q_rear_delta_Checksum[12] =
{
     ...
     while (imgsensor_info.i2c_addr_table[i] != 0xff) {
         ...
         do {
             *sensor_id = return_sensor_id()+2;
             ...
             LOG_INF("delta i2c write id : 0x%x, sensor id: 0x%x\n",imgsensor.i2c_write_id, *sensor_id);
             if((n26_hi5021q_rear_delta_eeprom_data.sensorVendorid >> 24) != hi5021q_read_eeprom(0x0001)){
               *sensor_id = 0xFFFFFFFF;
               return ERROR_SENSOR_CONNECT_FAIL;
          }
#if 1
  //// add maincamera hi5021q otp code
             size = imgSensorReadEepromData(&n26_hi5021q_rear_delta_eeprom_data,n26_hi5021q_rear_delta_Checksum);
             if(size != n26_hi5021q_rear_delta_eeprom_data.dataLength) {
                 LOG_INF("get eeprom data failed\n");
                 if(n26_hi5021q_rear_delta_eeprom_data.dataBuffer != NULL) {
                     kfree(n26_hi5021q_rear_delta_eeprom_data.dataBuffer);
                     n26_hi5021q_rear_delta_eeprom_data.dataBuffer = NULL;
                 }
                 *sensor_id = 0xFFFFFFFF;
                 return ERROR_SENSOR_CONNECT_FAIL;
             } else {
                 pr_info("get eeprom data success\n");
                 imgSensorSetEepromData(&n26_hi5021q_rear_delta_eeprom_data);
#if hi5021q_XGC_QGC_PGC_CALIB
//get the pgc qgc xgc buffer
memcpy(XGCbuffer, (kal_uint8*)&n26_hi5021q_rear_delta_eeprom_data.dataBuffer[hi5021Q_OTP_XGC_OFFSET+1], hi5021Q_OTP_XGC_LEN);
memcpy(QGCbuffer, (kal_uint8*)&n26_hi5021q_rear_delta_eeprom_data.dataBuffer[hi5021Q_OTP_QGC_OFFSET+1], hi5021Q_OTP_QGC_LEN);
memcpy(PGCbuffer, (kal_uint8*)&n26_hi5021q_rear_delta_eeprom_data.dataBuffer[hi5021Q_OTP_PGC_OFFSET+1], hi5021Q_OTP_PGC_LEN);

#if hi5021q_OTP_DUMP

LOG_INF("hi5021q_eeprom:pgc_addr:0x%x\n",n26_hi5021q_rear_delta_Checksum[hi5021q_PGC- 1].startAdress + 3);
LOG_INF("hi5021q_eeprom:qgc_addr:0x%x\n",n26_hi5021q_rear_delta_Checksum[hi5021q_QGC- 1].startAdress + 3);
LOG_INF("hi5021q_eeprom:xgc_addr:0x%x\n",n26_hi5021q_rear_delta_Checksum[hi5021q_XGC- 1].startAdress + 3);
...
UINT32 N26_HI5021Q_REAR_DELTA_MIPI_RAW_SensorInit(struct
