...
static int lcm_get_modes(struct drm_panel *panel)
{
	...
	strcpy(panel->connector->display_info.panel_name, "icnl9911c_hdp_vdo_dongshan_incell");
	strcpy(panel->connector->display_info.panel_supplier, "dongshan-icnl9911c");
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	if (strstr(saved_command_line, "mipi_mot_vid_dongshan_icnl9911c_720p_653") ||
